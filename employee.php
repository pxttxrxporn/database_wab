    ...
    <div class="row">
         <div class="col-md-4">
            <div class="dashboard-card">
                    <h3>User account</h3>
                    <p>Check general information details</p>
                    <a href="Add_NewUser.php" class="btn btn-primary">Go to account</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="dashboard-card">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="dashboard-card">
                    ...
                    <p>See concert details</p>
                    <a href="manage_concerts.php" class="btn btn-primary">Go to Manage</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="dashboard-card">
                    <h3>Sales Reports</h3>
                    <p>View sales statistics and reports</p>
                    <a href="sales_reports.php" class="btn btn-primary">View Reports</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="dashboard-card">
